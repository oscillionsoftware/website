        ...
        <div className="mx-auto px-4 space-y-8 text-gray-800">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              ...
              <li>Gaining unauthorized access to the website, its systems, or associated networks</li>
              <li>Transmitting obscene or offensive content</li>
              <li>Disrupting the normal flow of dialogue within our website</li>
              <li>Harassing or causing distress or inconvenience to any person</li>
              <li>Transmitting obscure or illegal content through the website</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Further, Oscillion Software does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its website or otherwise relating to such materials or on any sites linked to this site.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Oscillion Software does not make any commitment to update the materials.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              If you believe that your copyright has been infringed by material on any external website linked to our website, please report this to the relevant website owner.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              You may not reproduce, publish, transmit, distribute, display, modify, create derivative works from, or sell any content, in whole or in part, unless expressly permitted by Oscillion Software.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              ...
              <li>Taking responsibility for all activities that occur under your account</li>
              <li>Ensuring that your account information is accurate and up-to-date</li>
            </ul>
            <p className="mt-3">
              You agree to notify us immediately of any unauthorized use of your account or any other breach of security. We are not responsible for any loss or damage caused by your failure to protect your account information.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li>Transmitting or facilitating the transmission of any unlawful, offensive, threatening, libelous, slanderous, or otherwise objectionable material</li>
              <li>Disrupting the normal flow of dialogue or interaction within our website</li>
              <li>Attempting to gain unauthorized access to our systems or networks</li>
              <li>Transmitting any material that contains viruses or other malicious code</li>
              <li>Impersonating or attempting to impersonate any person or entity</li>
              <li>Collecting or tracking personal information for any purpose not expressly approved by us</li>
          ...
          <section>
            ...
            <div className="mt-3 space-y-2 text-gray-700">
              <p><span className="font-semibold">Email:</span> <a href="mailto:legal@oscillionsoftware.com" className="text-blue-600">legal@oscillionsoftware.com</a></p>
              <p><span className="font-semibold">Address:</span> Oscillion Software, [Company Address]</p>
            </div>
          </section>
